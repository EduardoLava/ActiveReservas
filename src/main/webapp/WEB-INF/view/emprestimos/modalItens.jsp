...
////        fazer o get para puxar os itens reservaveis disponiveis na data selecionada
        if(data !== null && data !== ''){
            if(idTipoItem !== null){
                $.get(
                        "${pageContext.request.contextPath}/emprestimos/disponiveis-data-tipos", 
            ...
            if(tipo !== ''){
                $.get("${pageContext.request.contextPath}/emprestimos/disponiveis-data-tipo", {"data": data ,"tipo" : tipo}, function(response){
                   $("#itens-disp").html(response); 
                });
                return;
            }
            
            $.get("${pageContext.request.contextPath}/emprestimos/disponiveis-data", {"data": data}, function(response){
                $("#itens-disp").html(response); 
            });
        }
    });
